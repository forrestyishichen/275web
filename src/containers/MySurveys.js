...
export default class AllGsurvey extends Component {
  ...
  handleSubmit = async event => {
    ...
    try {
          await this.postInvite();
          alert("Congrats! Thank you for invite your friend! A email with access link has been sent out!")
  ...
  postInvite() {
    ...
    $.post('http://localhost:8080/account/'+ id + '/survey/' + this.state.surveyId + '/invitation', {
    ...
    return (
      ...
      <div className="notes">
       <form onSubmit={this.handleSubmit}>
        ...
        <p>Please input your friend's email address!</p>
        <FormGroup controlId="inviteemail">
            <FormControl
              onChange={this.handleChange}
